...
public class PlayMenu extends State {
    ...
    public PlayMenu(MainMenu menuState, GameStateManager gsm) {
        setFont(new Font("Curlz MT", Font.CENTER_BASELINE, (int) (250 / Game.widthScaler)));
        this.keys = new boolean[256];
        this.menuState = menuState;
        this.gsm = gsm;
        
        this.menuButtonText = new String[]{"Arcade", "Campaign", "back"};
    ...
    private void execute() {
        if (currentSelection == 0) {
            gsm.setState(new NumberOfPlayersMenu(this, gsm));
        }
        if (currentSelection == 1) {
            gsm.setState(new CampaignMenu(this, gsm));
        }
